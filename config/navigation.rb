SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :authors, 'Authors' do |authors|
      ...
      authors.item :author_sign_in, 'Sign In', new_author_session_path, if: ->{!author_signed_in? && !AppSetting.sign_in_disabled?}
      authors.item :author_sign_up, 'Sign Up', new_author_registration_path, if: ->{!author_signed_in? && !AppSetting.sign_in_disabled?}
